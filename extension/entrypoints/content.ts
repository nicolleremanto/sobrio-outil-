/**
 * Content script Sobrio sur https://claude.ai/* — Lot A (squelette).
 *
 ...
 *  - aucun clic simulé, aucune pré-sélection de modèle dans claude.ai ;
 *  - le DOM fonctionnel de claude.ai n'est JAMAIS modifié : notre panneau vit
...
import { resolveInputArea } from '../src/selectors';

...
| Module | Rôle |
| --- | --- |
| `types.py` | Dataclasses gelées : `PromptSignals`, `ConversationSignals`, `Signals`, `Decision` (schéma RFC-0001). `prompt_text` est un point d'extension RÉSERVÉ (étage 2, R6) — `None` partout en v0/v0.5. |

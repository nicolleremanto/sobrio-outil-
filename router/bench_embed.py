...
_MOTS_VIDES = {
    "fr": (
        ...
        "sur", "par", "pour", "avec", "sans", "sous", "vers", "chez",
        "donc", "or", "ni", "car", "mais", "si", "que", "qui", "ne",
        "pas", "plus", "en", "au", "aux", "du", "se", "sa", "son", "ses",
    ),
    "en": (
        "the", "a", "an", "of", "and", "or", "in", "on", "at", "by",
        "for", "with", "without", "under", "over", "to", "from", "but",
        "if", "that", "which", "who", "not", "no", "so", "as", "than",
        "then", "this", "these", "those", "its", "their", "our", "is", "are",
    ),
}
